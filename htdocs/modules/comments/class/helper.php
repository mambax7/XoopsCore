...
{
    public const APPROVE_NONE = 0;

    public const APPROVE_ALL = 1;

    public const APPROVE_USER = 2;
    ...
    public const DISPLAY_OLDEST_FIRST = 0;

    public const DISPLAY_NEWEST_FIRST = 1;
