...
$totalsubmitted = $publisher->getItemHandler()->getItemsCount(-1, [_PUBLISHER_STATUS_SUBMITTED]);

// Total published ITEMs
$totalpublished = $publisher->getItemHandler()->getItemsCount(-1, [_PUBLISHER_STATUS_PUBLISHED]);

// Total offline ITEMs
$totaloffline = $publisher->getItemHandler()->getItemsCount(-1, [_PUBLISHER_STATUS_OFFLINE]);

// Total rejected
$totalrejected = $publisher->getItemHandler()->getItemsCount(-1, [_PUBLISHER_STATUS_REJECTED]);
