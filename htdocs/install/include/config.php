...
$configs['db_types'] = [];
if (in_array('mysql', $available_pdo_drivers, true)) {
...
if (in_array('sqlite', $available_pdo_drivers, true)) {
...
if (in_array('pgsql', $available_pdo_drivers, true)) {
...
if (in_array('oci', $available_pdo_drivers, true)) {
...
if (in_array('sqlsrv', $available_pdo_drivers, true)) {
