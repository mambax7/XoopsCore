...
{
    public const CUSTOM_HTML = 'H'; // custom HTML block

    public const CUSTOM_PHP = 'P'; // custom PHP block

    public const CUSTOM_SMILIE = 'S'; // use text sanitizer (smilies enabled)

    public const CUSTOM_TEXT = 'T'; // use text sanitizer (smilies disabled)

    public const BLOCK_TYPE_SYSTEM = 'S'; // S - generated by system module

    public const BLOCK_TYPE_MODULE = 'M'; // M - generated by a non-system module

    public const BLOCK_TYPE_CUSTOM = 'C'; // C - Custom block

    public const BLOCK_TYPE_CLONED = 'D';
